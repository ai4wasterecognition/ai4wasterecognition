...
For the concrete publication and modeling strategy, see [publication-and-modeling.md](publication-and-modeling.md).
...
- exporter and training code:
  - [scripts/radar_dataset_v1/export_dataset.py](../../../scripts/radar_dataset_v1/export_dataset.py)
  - [scripts/radar_dataset_v1/build_release.py](../../../scripts/radar_dataset_v1/build_release.py)
  - [scripts/radar_dataset_v1/train_transformer.py](../../../scripts/radar_dataset_v1/train_transformer.py)
