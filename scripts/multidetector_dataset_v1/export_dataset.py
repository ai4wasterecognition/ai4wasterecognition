#!/usr/bin/env python3
"""Build the multidetector_dataset_v1 publishable release.

Reads:
    processed/multidetector_dataset_v1/df_bins.parquet           (Krok 1 output)
    processed/multidetector_dataset_v1/sample_mapping.csv        (Krok 2 output)

Writes into <release_dir> (default release/multidetector_dataset_v1/):
...
DEFAULT_BINS = Path("processed/multidetector_dataset_v1/df_bins.parquet")
DEFAULT_MAPPING = Path("processed/multidetector_dataset_v1/sample_mapping.csv")
DEFAULT_RELEASE = Path("release/multidetector_dataset_v1")
...
SPLIT_SEED = 42
DATASET_VERSION = "multidetector_dataset_v1.0.0"
