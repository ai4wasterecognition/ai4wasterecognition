#!/usr/bin/env python3
"""Run inference on raw radar .txt frames using a trained multidetector model.

Usage:
    # single file
    python infer.py --model models/multidetector_dataset_v1/transformer_..._label_category.pt \
